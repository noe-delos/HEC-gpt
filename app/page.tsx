...
const SuggestionButton: React.FC<SuggestionButtonProps> = ({ text, icon, color, onClick }) => (
  <motion.button
    ...
    whileTap={{ scale: 0.97 }}
    className="px-4 py-2 rounded-full bg-[#01407A]/20 text-[#01407A] hover:bg-[#01407A]/10 text-sm flex items-center gap-2"
    onClick={onClick}
  >
...
const SendButton: React.FC<SendButtonProps> = ({ disabled, type = "submit" }) => (
  <motion.button
    ...
    type={type}
    disabled={disabled}
    className="rounded-full bg-[#01407A] hover:bg-[#e95136] h-10 w-10 flex items-center justify-center text-white disabled:cursor-not-allowed"
  >
...
export default function Page() {
  ...
  const customSubmit = (e: FormEvent) => {
    ...
    const currentCount = parseInt(localStorage.getItem('userMessageCounthec') || '0');
      ...
      <div className="w-full relative">
        <div className="max-w-5xl mx-auto px-4 py-3">
          ...
          <div className="flex items-center space-x-3 fixed top-3 left-4 z-10 cursor-pointer" onClick={() => router.push('/')}>
            <Image src='/logo.png' alt='logo' width={100} height={100} className='size-[1.5rem] sm:h-[3rem] w-full' />
          </div>
        </div>
      </div>
            ...
            {!hasMessages ? (
              ...
              <div className="py-20 text-center max-w-4xl mx-auto">
                <div className='flex flex-col sm:flex-row items-center size-fit gap-4 mx-auto h-fit mb-14'>
                  ...
                  >
                    <AuroraText className='text-3xl'>Justine</AuroraText>, l'assistante alumni de l'HEC.
                  </motion.h2>
                  <video
                    src='/justine.mp4'
                    autoPlay
                ...
                >
                  <form ref={formRef} onSubmit={customSubmit} className="relative">
                    ...
                    <div className="absolute left-3 bottom-4 bg-[#01407A]/20 text-[#01407A] rounded-full px-3 py-1 flex items-center gap-2 text-sm pointer-events-none">
